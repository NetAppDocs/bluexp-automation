...
=== Prerequisites
You need to have a NetApp BlueXP website account. Refer to link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-signing-up.html[Signing up to NetApp BlueXP website] for more information.
