...
.Prerequisites
You need to have a NetApp BlueXP account. Refer to link:https://docs.netapp.com/us-en/bluexp-setup-admin/task-sign-up-saas.html[Sign up or log in to BlueXP^] for more information.
