...
=== Prerequisites
You need to have a NetApp Cloud Central account with access to BlueXP. Refer to link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-signing-up.html[Signing up to NetApp Cloud Central] for more information.
...
+
image:api2.png[Redirect the browser to NetApp Cloud central login page]
