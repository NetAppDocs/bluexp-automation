...
// The Cloud Manager platform consists of multiple services, each with a dedicated REST API. Each Cloud Manager platform API, and each of the API endpoints within a specific service, can have different authorization requirements and usage.
...
---------------------------------------------------------------------
{
    ...
    "client_id": "O6AHa7kedZfzHaxN80dnrIcuPBGEUvEv"
}
---------------------------------------------------------------------
...
---------------------------------------------------------------------
{
    ...
    "client_id": "VcPXCf6rPTPQsyS2oIt6SP5ZSgnUHI3S",
    "client_secret": "VCdpytowenfd3280ngfdkghi95o00t"
}
---------------------------------------------------------------------
