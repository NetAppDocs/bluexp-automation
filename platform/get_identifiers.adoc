...
. You can optionally derive the associated client ID by removing the `clients` suffix. This ID applies when accessing a connector in local mode (not through the SaaS interface).
+
*Example*
