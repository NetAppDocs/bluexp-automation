...
. You can optionally derive the associated client ID by removing the `clients` suffix. This ID applies when accessing a connector directly in local mode and not through the SaaS interface.
+
*Example*
