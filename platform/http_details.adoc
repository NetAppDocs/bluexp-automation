...
|This Cross Origin Resource Sharing (CORS) header indicates whether the response can be shared with requesting code from the specified origin.
|`content-encoding`
|This header specifies the type of encoding used on the data. 
|`content-type`
