...
The HTTP methods supported by the Cloud Manager REST API are shown in the following table. Not all the HTTP methods are available at each of the REST endpoints. For more information, see the reference documentation for the specific API you are using.
