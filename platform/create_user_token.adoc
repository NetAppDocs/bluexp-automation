...
This API call uses the _Auth0_ authentication service and not the NetApp BlueXP service. See the URL in the curl example below and adjust for your environment as needed.
