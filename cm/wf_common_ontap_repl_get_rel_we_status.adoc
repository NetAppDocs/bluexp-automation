...
.Google Cloud
--
Perform the workflow link:wf_aws_cloud_get_wes.html[Get GCP working environments] and choose the `publicId` value for the `workingEnvironmentId` query parameter.
--
====
