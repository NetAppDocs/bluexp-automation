...
=== 2. Select regions
Perform the link:wf_azure_cloud_md_get_regions.html[Get regions] workflow and choose the `zone: name` value of the required region for the `zone` query parameter.
