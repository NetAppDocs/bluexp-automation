...
Perform the link:wf_aws_cloud_md_get_key_pairs.html#get-key-pairs-for-high-availability-pair[Get key pairs] workflow and select the required key for `haParam: mediatorKeyPairName` parameter in step 11.
