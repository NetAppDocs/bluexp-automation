...
[.lead]
You can create a new Cloud Volumes ONTAP working environment using link:https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-licensing.html#capacity-based-licensing[capacity-based licensing^].
