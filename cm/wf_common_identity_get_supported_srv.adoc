...
[NOTE]
This workflow describes how to use the REST API to retrieve the two ID values. You can also use the BlueXP web UI to get these values. See link:get_identifiers.html[Get required identifiers] for more information.
