---
sidebar: sidebar
permalink: wf_aws_ontap_delete_volume.html
...
Perform the workflow link:wf_aws_cloud_get_wes.html#get-working-environment-for-single-node[Get working environments] and choose the `publicId` value for the working environment and `svmName` to be used in `workingEnvironmentId` and `svmName` path parameters.
...
Perform the workflow link:wf_aws_cloud_get_wes.html#get-working-environment-for-high-availability-pair[Get working environments] and choose the `publicId` value for the working environment and `svmName` to be used in `workingEnvironmentId` and `svmName` path parameters.
