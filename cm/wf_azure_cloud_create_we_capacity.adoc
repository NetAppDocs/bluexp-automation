...
Choose a package name for the `vsaMetadata:capacityPackageName` parameter in step 13. There are five licensing package options available: `Professional`, `Essentials`, `Freemium`, `Edge Cache`, and `Optimized`.
