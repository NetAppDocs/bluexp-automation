...
Perform the workflow link:wf_gcp_cloud_md_get_projects.html[Get projects] and choose the `projectId` value of the required project for `project` parameter in step 9.
...
Perform the workflow link:wf_gcp_cloud_md_get_permutations.html[Get permutations] and choose the `ontapVersion`, `license: type`, and `instanceType` values of the required `vsaMetadata` parameter in step 9.
...
Perform the workflow link:wf_gcp_cloud_md_get_service_accounts.html[Get service accounts] workflow and choose the `email` value of the required service accounts for the `gcpServiceAccount` parameter in step 9.
...
[source,json]
{
    ...
    "creatorUserEmail": "auth0|5e576e5205a0dc0c1714a4f8",
    "status": null,
    "providerProperties": null,
    "reservedSize": null,
    "clusterProperties": null,
