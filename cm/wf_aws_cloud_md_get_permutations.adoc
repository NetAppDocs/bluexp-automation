---
sidebar: sidebar
permalink: wf_aws_cloud_md_get_permutations.html
...
You can use this workflow to get permutations for a single node working environment.
...
You can use this workflow to get permutations for an HA working environment.
