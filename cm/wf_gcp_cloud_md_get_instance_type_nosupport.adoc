...
You can use this workflow to retrieve the GCP instance types which do not support the acceleration and capacity tiering in a single node working environment.
...
== Get instance types for single node
You can use this workflow to retrieve the GCP instance types which do not support the acceleration and capacity tiering in an HA working environment.
