...
* ONTAP on-premises workflows: This set of workflows enable you to discover and manage the on-premises ONTAP clusters. 

There's similarity between the functional categories of the Cloud Volumes ONTAP and on-premises ONTAP workflows, however, there are a few key differences noted as follows.
