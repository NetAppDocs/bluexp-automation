...
[NOTE]
Before getting started with the workflows, see Workflow processes and tasks for an introduction to how workflows and tasks are generally used with BlueXP.
