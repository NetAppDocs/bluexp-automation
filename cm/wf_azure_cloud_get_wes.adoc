...
Perform the link:wf_azure_cloud_create_we_paygo.html[Create Azure dual node working environment] workflow and select the `publicId` from the output for the `workingEnvironmentId` path parameter.
