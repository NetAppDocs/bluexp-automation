...
[NOTE]
Review the link:https://docs.netapp.com/us-en/bluexp-automation/cm/prepare.html[Get started] section before using any of the Cloud Volumes ONTAP REST API workflows.
...
[NOTE]
The link:https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-aws-elastic-volumes.html[Amazon EBS Elastic Volumes] feature is enabled by default on new Cloud Volumes ONTAP 9.11.0 or later systems when using `gp3` or `io1` disks.
