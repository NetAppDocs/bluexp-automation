...
== Delete a single node working environment
...
Perform the workflow link:[Create Azure single node working environment] and choose the `publicId` value of the working environment for the `workingEnvironmentId` path parameter.
...
== Delete a  working environment for high availability pair
You can use this workflow to delete an HA working environment.

=== 1. Select the working environment to use

Perform the workflow link:[Create Azure HA working environment] and choose the `publicId` value of the working environment for the `workingEnvironmentId` path parameter.
