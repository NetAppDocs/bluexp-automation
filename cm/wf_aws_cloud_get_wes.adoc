---
sidebar: sidebar
permalink: wf_aws_cloud_get_wes.html
...
You can use this workflow to get a list of working environments for a single node system.
...
You can use this workflow to get the list of working environments for an HA pair.

=== 1. Get working environment
...
Output::
The JSON output example includes an array of HA Cloud Volumes ONTAP working environments.
