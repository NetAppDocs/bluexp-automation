...
Review the link:../platform/http_details.html[REST implementation details] for information about REST concepts and the details of how a REST API is designed.
