...
==== Creates a new AWS Cloud Volumes ONTAP filesystem.
----
POST /aws/filesystem/vsa
----
...
|===
|Type|Name|Description|Required|Schema|Default
|BodyParameter|body||true|link:../cm/api_ref_definitions.html#createsinglefilesystemrequest[CreateSingleFilesystemRequest]|
|===
...
=== Ontaps:working-environments
==== Clones an existing volume.Operation may only be performed on working environments whose status is: ON
----
POST /ontaps/working-environments/{workingEnvironmentId}/{svmName}/{volumeName}/clone
----
...
==== Return a list of snapshot descriptions for the volume.Operation may only be performed on working environments whose status is: ON
----
GET /ontaps/working-environments/{workingEnvironmentId}/{svmName}/{volumeName}/snapshots
----
...
==== Deletes an existing volume.Operation may only be performed on working environments whose status is: ON
----
DELETE /ontaps/working-environments/{workingEnvironmentId}/{svmName}/{volumeName}
----
...
==== Modify an existing volume.Operation may only be performed on working environments whose status is: ON, DEGRADED
----
PUT /ontaps/working-environments/{workingEnvironmentId}/{svmName}/{volumeName}
----
...
==== Retrieves volumes for Backup Activation.Operation may only be performed on working environments whose status is: ON
----
GET /ontaps/working-environments/volumes-for-backup
----
...
==== Retrieves volumes.Operation may only be performed on working environments whose status is: ON, DEGRADED
----
GET /ontaps/working-environments/{workingEnvironmentId}/volumes
----
...
|Type|Name|Description|Required|Schema|Default
|QueryParameter|fields||false|string|
|PathParameter|workingEnvironmentId|Filter volumes by this working environment|true|string|
|===
...
==== Creates a new volume. If the properties aggregateName and maxNumOfDisksApprovedToAdd are not filled in, then the response will fail with a suggested aggregate name and the number of disks that will need to be created in order to fulfill the request.Operation may only be performed on working environments whose status is: ON, DEGRADED
----
POST /ontaps/working-environments/{workingEnvironmentId}/volumes
----
...
|===
|Type|Name|Description|Required|Schema|Default
|PathParameter|workingEnvironmentId|Create volume in this working environment|true|string|
|QueryParameter|createAggregateIfNotFound|On create volume request, allow creating not-found aggregate|false|boolean|
|BodyParameter|body|Create volume request|true|link:../cm/api_ref_definitions.html#ontapcreatevolumerequest[OntapCreateVolumeRequest]|
|===
...
==== Retrieves volume by id.Operation may only be performed on working environments whose status is: ON, DEGRADED
----
GET /ontaps/working-environments/{workingEnvironmentId}/volume/{volumeId}
----
...
|Type|Name|Description|Required|Schema|Default
|QueryParameter|fields||false|string|
|PathParameter|workingEnvironmentId|Filter volume by this working environment|true|string|
...
==== Retrieves aggregates.Operation may only be performed on working environments whose status is: ON, INITIALIZING, DEGRADED
----
GET /ontaps/working-environments/{workingEnvironmentId}/aggregates
----
...
==== Delete snapshot manually.Operation may only be performed on working environments whose status is: ON, DEGRADED
----
DELETE /ontaps/working-environments/{workingEnvironmentId}/{svmName}/{volumeName}/snapshot
----
...
==== Create snapshot manually.Operation may only be performed on working environments whose status is: ON
----
POST /ontaps/working-environments/{workingEnvironmentId}/{svmName}/{volumeName}/snapshot
----
