...
==== Validate an Azure account request. Deprecated, please see release notes.
----
...
==== Updates an existing Azure account. Deprecated, please see release notes.
----
...
==== Retrieves an Azure account by public Id. Deprecated, please see release notes.
----
...
==== Creates an Azure account. Deprecated, please see release notes.
----
POST /accounts/azure
----
...
==== Create a Gcp Storage account. Deprecated, please see release notes.
----
POST /accounts/gcp
----
...
==== Deletes an existing account. It is not possible to delete an account that has working environments attached to it. Deprecated, please see release notes.
----
...
==== Retrieves accounts. Deprecated, please see release notes.
----
GET /accounts
----
...
==== Retrieves all accounts that are only for cloud (AWS, AZURE, GCP). Deprecated, please see release notes.
----
...
==== Creates an AWS account. Deprecated, please see release notes.
----
POST /accounts/aws
----
...
==== get aws cloud account id for the given creds. Deprecated, please see release notes.
----
...
==== Updates an existing AWS account. Deprecated, please see release notes.
----
...
==== Retrieves an AWS account by public Id. Deprecated, please see release notes.
----
...
==== Validate gcp account request. Deprecated, please see release notes.
----
...
==== Updates an existing Gcp storage account. Deprecated, please see release notes.
----
...
==== Retrieve Gcp Storage account by public Id. Deprecated, please see release notes.
----
...
==== Enable Snaplock to an existing Cloud Volumes ONTAP working environment
----
...
|Type|Name|Description|Required|Schema|Default
|PathParameter|workingEnvironmentId|Public Id of working environment|true|string|
|BodyParameter|body|Worm Enable request|true|link:../cm/api_ref_definitions.html#wormrequest[WormRequest]|
|===
...
==== Validate pre-req for conversion of an existing Cloud Volumes ONTAP working environment
----
...
==== Enable Snaplock to an existing Cloud Volumes ONTAP working environment.Operation may only be performed on working environments whose status is: ON.
----
...
==== Validate pre-req for conversion of an existing Cloud Volumes ONTAP working environment.Operation may only be performed on working environments whose status is: ON.
----
...
==== Updated byol licence to capacity based license to an existing Cloud Volumes ONTAP working environment.Operation may only be performed on working environments whose status is: ON.
----
