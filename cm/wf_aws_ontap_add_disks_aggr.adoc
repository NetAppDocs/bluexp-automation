---
sidebar: sidebar
permalink: wf_aws_ontap_add_disks_aggr.html
...
[.lead]
You can add disks to an existing aggregate. Choose the correct workflow depending on the type of Cloud Volumes ONTAP deployment:
