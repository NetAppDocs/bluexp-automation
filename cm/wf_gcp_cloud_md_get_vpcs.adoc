...
[.lead]
You can perform this workflow to retrieve the GCP networks and subnetworks over which a Cloud Volumes ONTAP working environment might be created.
...
The JSON output example includes the list of GCP networks and subnetworks.
