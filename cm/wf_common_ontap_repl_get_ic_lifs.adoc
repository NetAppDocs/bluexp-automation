...
.Google cloud
--
Perform the workflow link:wf_gcp_cloud_get_wes.html[Get GCP working environments] and choose the `publicId` values for the working environment query parameters.
--
====
