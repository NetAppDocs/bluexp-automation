...
keywords: paygo, cloud, volumes, ontap, connector, BlueXP, region, workspace, capacity-based
...
* To create a new NSS key using the BlueXP user interface, perform the task link:../platform/get_nss_key.html[Generate NSS user ID] and choose the NSS ID.
