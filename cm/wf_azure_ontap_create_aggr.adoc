...
Perform the workflow link:wf_azure_cloud_create_we_paygo.html[Create Azure HA working environment] and choose the `publicId` value for the `workingEnvironmentId` parameter in the JSON input.
