...
[.lead]
You can use this workflow to create an Azure cloud provider account. An Azure Cloud Provider Account holds Azure access keys required to perform actions in Azure cloud.
