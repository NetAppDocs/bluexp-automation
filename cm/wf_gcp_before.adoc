...
[.lead]
Cloud Volumes ONTAP requires a Google Cloud service account to run several background automation tasks such as data tiering and backup service. This service account needs to be authenticated and should be authorized to access Cloud Manager APIs.
