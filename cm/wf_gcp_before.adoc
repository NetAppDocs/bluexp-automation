...
== Azure credentials
Before beginning to use the Azure workflows, you'll need to create an  account through the Microsoft Azure portal and obtain the Azure credentials and the  subscription ID.
