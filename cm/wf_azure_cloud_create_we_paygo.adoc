...
* <<Create working environment with BYOL for single node, Single Node>>
* <<Create working environment with BYOL for high availability pair, HA pair>>

== Create a single node working environment with PAYGO
You can use this workflow to create single node working environment with PAYGO licensing.
...
== Create an HA working environment with PAYGO
You can use this workflow to create an HA working environment with PAYGO licensing.
...
[source,json]
{
   ...
   "writingSpeedState":"NORMAL",
   "subnetId":"/subscriptions/d333af45-0d07-4154-943d-c25fbbce1b18
/resourceGroups/occm_group_westeurope/providers/Microsoft.Network/virtualNetworks/Vnet1/subnets/Subnet2",
   "svmPassword":"Netapp123",
   "vnetId":"/subscriptions/d333af45-0d07-4154-943d-c25fbbce1b18/resourceGroups
...
[source,json]
{
   ...
   "name":"ranukazure12",
   "tenantId":"Tenant-KWNJW8bs",
   "svmName":"svm_ranukazure12",
   "creatorUserEmail":"auth0|606b6467d0e04300696f3c3d",
   "status":null,
   "providerProperties":null,
   "reservedSize":null,
   "clusterProperties":null,
