---
sidebar: sidebar
permalink: api_ref_definitions.html
keywords:
summary:
---
...
|setDefaultStorageClass||true|boolean|
|setSanDefaultStorageClass||true|boolean|
|===
...
|gcpVolumeType|GCP volume type|true|enum (pd-standard,  pd-ssd)|
...
|===
|Name|Description|Required|Schema|Default
|providerKeys||true|<<CvsAccountCredentials>>|
|===
...
|accountName||true|string|
|accountType||true|string|
|cvsAccessKey||true|string|
|cvsSecretKey||true|string|
|cvsRegion||true|string|
|===
...
|===
|Name|Description|Required|Schema|Default
|contextName||false|string|
|clusterName||false|string|
|clusterEndpoint||false|string|
|currentContext||false|boolean|
|connectivity||false|boolean|
|alreadyExists||false|boolean|
|===
...
|===
|Name|Description|Required|Schema|Default
|k8sconfig||true|string|
|contexts||true|<<K8sContext>> array|
|===
...
|k8sVersion||true|string|
|tridentVersion||true|string|
|connectedWeIds||true|string array|
|connectivity||true|boolean|
|isOurStorageClassDefault||true|boolean|
|isOurSanStorageClassDefault||true|boolean|
|nksInfo||false|<<NksInfoResponse>>|
|===
...
|===
|Name|Description|Required|Schema|Default
|mainClusterIds||true|string array|
|connectedClusterIds||true|string array|
...
|===
|Name|Description|Required|Schema|Default
|k8sconfig|Kubernetes config file contents in YAML format|true|string|
|contextNames|Context names to use|true|string array|
|===
...
|capacityPackageName|Optional Capacity Based Package|false|enum (Professional)|
