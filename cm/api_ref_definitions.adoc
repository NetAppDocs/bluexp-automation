...
|===
|Name|Description|Required|Schema|Default
|accessPoint||false|string|
|primary||false|string|
|secondary||false|string|
|===
...
|===
|Name|Description|Required|Schema|Default
|shareInfo||true|<<CifsShareInfo>> array|
|accessPoints||true|<<AccessPoints>>|
|===
...
|===
|Name|Description|Required|Schema|Default
|parentVolume||true|<<Identifier>>|
|parentSnapshot||true|<<Identifier>>|
|childVolumes||true|string array|
|===
...
|ebsVolumeType|EBS volume type|true|enum (gp2,  st1,  io1,  io2)|
|instanceType|Instance Type|true|string|
|nodeCustomerDataEni||true|<<NetworkInterfaceInfo>>|
|subnetId||true|string|
|serialNumber||true|string|
|awsEncryptionParameters|Parameters required if using aws encryption - system|false|<<AwsEncryption>>|
|dataAwsEncryptionParameters|Parameters required if using aws encryption - data|false|<<AwsEncryption>>|
...
|===
|Name|Description|Required|Schema|Default
|compression||true|<<CompressionResponse>>|
|deduplication||true|<<DeduplicationResponse>>|
|===
...
|primaryNoFailover||false|string|
|SecondaryNoFailover||false|string|
|===
...
|===
|Name|Description|Required|Schema|Default
|exportPolicy||true|<<NamedExportPolicyInfo>>|
|mountPoints||true|<<MountPoints>>|
|===
...
|volumeTags|Optionally provide key-value pairs with which to tag the ONTAP volume using App Template service|false|<<VolumeTags>> array|
|csiInfo||true|<<CreateIscsiInfoRequest>>|
|===
...
|===
|Name|Description|Required|Schema|Default
|cloudProtected||false|boolean|
|ontapProtected||false|boolean|
|===
...
|Name|Description|Required|Schema|Default
|policy||false|string|
|minCoolingDays||false|integer (int32)|
|type||false|string|
|used||false|<<Capacity>>|
|tierInactiveUserData||false|<<Capacity>>|
|tierInactiveUserDataPercent||false|integer (int32)|
|===
...
=== VolumeProviderPropertiesResponse
[options="header"]
|===
|Name|Description|Required|Schema|Default
|volumeType||false|string|
|tags||true|<<Tag>> array|
|iops||false|integer (int32)|
|throughput||false|integer (int32)|
|===
...
=== OntapsVolumesResource:VolumeResponse
[options="header"]
|===
|Name|Description|Required|Schema|Default
|name|Volume name|true|string|
|uuid|Volume id|true|string|
|svmName|Volume SVM name|true|string|
|size|Volume total size|true|<<Capacity>>|
|usedSize|Volume used size|true|<<Capacity>>|
|junctionPath|The junction path at which this volume is mounted|true|string|
|inodes|The total and used inodes size|true|<<InodesResponse>>|
|thinProvisioned|Whether volume is thin provisioned|true|boolean|
|efficiency|Efficiency|false|<<EfficiencyResponse>>|
|snapshotPolicy|The name of the Snapshot policy|true|string|
|securityStyle|The type of the Security style|true|string|
|state|state|true|string|
|volumeType|Volume type|true|string|
|aggregateName|Aggregate name|true|string|
|autosize|The operating mode of autosize|true|<<AutoSizeResponse>>|
|clones|Clone Properties|true|<<CloneResponse>>|
|volumeProviderProperties|Volume Provider Properties|false|<<VolumeProviderPropertiesResponse>>|
|volumeIsMoving|Is Volume during move process|false|boolean|
|ProtocolNfs|NfsResponse|false|<<NfsResponse>>|
|ProtocolCifs|CifsResponse|false|<<CifsResponse>>|
|ProtocolIscsi|IscsiResponse|false|<<IscsiResponse>>|
|comment|Volume comment|false|string|
|qosPolicyGroupName|Quality of service policy group name|false|string|
|snaplock|Snaplock type|true|<<SnaplockResponse>>|
|constituentsAggregates|Aggregates which are used for FlexGroup constituents|true|string array|
|snapshotsUsedSize|The size that is used by snapshots in the volume|false|<<Capacity>>|
|cbsBackupsInfo|Backup to Cloud Service info|false|<<VolumeCbsInfo>>|
|tiering|TieringResponse|true|<<TieringResponse>>|
|snapmirror|SnapmirrorResponse|true|<<SnapmirrorResponse>>|
|flexGroupVolume||true|boolean|
|svmRoot||true|boolean|
|===
