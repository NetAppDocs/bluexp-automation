...
Perform the workflow link:wf_azure_cloud_md_get_regions.html[Get regions] and choose the `zone:name` value of the required region for the `region` parameter in step 10.
