...
You can use this workflow to get volume for a single node working environment.

=== 1. Create the working environment

Perform the workflow link:wf_azure_cloud_create_we_paygo.html[Create Azure single node working environment] and choose the `publicId` value of the working environment for the `workingEnvironmentId` query parameter.
...
You can use this workflow to get volume for an HA working environment.

=== 1. Create the working environment

Perform the workflow link:wf_azure_cloud_create_we_paygo.html[Create Azure HA working environment] and choose the `publicId` value of the working environment for the `workingEnvironmentId` query parameter.
...
[
    {
        "name": "vol1",
        "uuid": "5c0f7791-6279-11eb-b9a9-000d3ae60645",
    ...
    {
        "name": "vol2",
        "uuid": "682a2253-6279-11eb-b9a9-000d3ae60645",
        "svmName": "svm_ShirleyHa2901",
        "size": {
            "size": 30.0,
            "unit": "GB"
